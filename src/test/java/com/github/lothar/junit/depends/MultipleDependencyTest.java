...
import com.github.lothar.junit.depends.DependencyRunner;
import com.github.lothar.junit.depends.DependsOn;
...
public class MultipleDependencyTest {
    ...
    @Test
    @DependsOn({"test_method3", "test_method4"})
